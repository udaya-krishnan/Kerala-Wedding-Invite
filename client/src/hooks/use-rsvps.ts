...
import type { RsvpInput, RsvpsListResponse } from "@shared/routes";

export function useRsvps() {
  return useQuery<RsvpsListResponse>({
...
export function useCreateRsvp() {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "RSVP Received",
        description: "Thank you for confirming your presence. May the divine blessings be with you.",
      });
    },
    onError: (error) => {
      toast({
